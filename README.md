...
- Telegram Bot Remote
- Telegram Bot Seller Panel [**Telegram Bot Panel**](https://github.com/GegeDesembri/sshvpn-telegram-panel)
- HideSSH Web Panel Support [_Included_] - Source [HideSSH Web Panel Plugin](https://github.com/hidessh99/Developers)
